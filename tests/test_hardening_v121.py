...
def test_ci_is_pinned_frozen_and_exercises_release_contract():
    ...
    # v1.2.13 M2: full history is required so the pristine-manifest oracle can
    # read the pinned pristine commit's blobs instead of skipping.
